...
<div class="panel panel-default">
  <div class="panel-body">
    {!!Form::open(['method'=>'put','url'=>PREFIX.'/role/'.$data->id, 'class'=>'form-horizontal'])!!}
                ...
                <div class="col-xs-12" style="margin-top:15px; margin-bottom:3px;">
                  ...
                  <div class="col-lg-6">
                    <label class="sub-label">
                      <input type="checkbox" name="permissions[]" id="{{$key.'_module'}}" data-module="{{$key}}" value="{{$key.".".$value}}" class="modulesClass permission {{$key.'_module'}}"
