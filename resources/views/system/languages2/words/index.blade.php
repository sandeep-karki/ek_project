...
<div id="page-title">
    ...
    <div class="right" style="float:right">
      <a class="btn btn-primary" href="{{URL::to(PREFIX.'/words/create')}}"><i class="glyph-icon icon-plus" style="margin-right:10px;"></i>{{ translate('Add New') }}</a>
    </div>
</div>
          ...
          <tbody>
            ...
            <tr>
                ...
                <td>
                  ...
                  <a href="javascript:void(0)" data-toggle="modal" data-target="#confirm-delete" data-href="{{URL::to(PREFIX.'/words/'.$pData->id)}}" class="btn btn-sm btn-danger"><i class="glyph-icon icon-trash"></i> {{ translate('Delete') }}</a>
                  </a>
                </td>
            </tr>
            @endforeach
